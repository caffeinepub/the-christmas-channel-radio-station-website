...
function getWeatherIcon(code: number) {
  ...
  if (code >= 95 && code <= 99)
    return <CloudLightning className="h-10 w-10 text-purple-600" />;
...
export default function PublicWeatherForecast() {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: fetchWeatherData is stable
  useEffect(() => {
    fetchWeatherData();
      ...
      <section className="mb-16">
        ...
        <Card className="bg-white/95 backdrop-blur-sm border-christmas-red border-2 p-8 shadow-xl">
          <div className="text-center py-8">
            ...
            <p className="text-christmas-red font-semibold text-lg mb-2">
        ...
        <div className="bg-gradient-to-r from-christmas-red/10 via-christmas-gold/10 to-christmas-green/10 p-6 border-b-2 border-christmas-gold">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">
              {lastFetch &&
                `Last updated: ${lastFetch.toLocaleString("en-US", {
                  month: "short",
                  day: "numeric",
                  hour: "numeric",
                  minute: "2-digit",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-7 gap-4">
            {weatherData.map((day, index) => (
              ...
              >
                <div className="text-center">
                  <p
                    className={`font-bold mb-3 ${index === 0 ? "text-christmas-red text-lg" : "text-gray-700"}`}
                  >
                    {formatDate(day.date)}
                  </p>
