  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        {/* Corner ornaments */}
        <div
          className="absolute top-4 left-4 w-8 h-8 rounded-full bg-christmas-red/40 blur-sm animate-pulse"
          style={{ animationDuration: "3s" }}
        />
        <div
          className="absolute top-4 right-4 w-8 h-8 rounded-full bg-christmas-gold/40 blur-sm animate-pulse"
          style={{ animationDuration: "2.5s" }}
        />
        <div
          className="absolute top-12 left-12 w-6 h-6 rounded-full bg-christmas-green/40 blur-sm animate-pulse"
          style={{ animationDuration: "2s" }}
        />
        <div
          className="absolute top-12 right-12 w-6 h-6 rounded-full bg-christmas-red/40 blur-sm animate-pulse"
