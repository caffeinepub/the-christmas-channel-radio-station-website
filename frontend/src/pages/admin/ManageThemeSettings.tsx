          ...
          <Card className="bg-white/95 backdrop-blur-sm border-christmas-gold border-2">
            <div className="p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div>
                    <Label htmlFor="newsfeed-toggle" className="text-base font-semibold text-christmas-dark">
                      News Feed
                    </Label>
                    <p className="text-sm text-gray-600 mt-1">
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <span className="text-sm font-medium text-gray-700">News Feed</span>
                    <span className={`text-sm font-semibold ${showNewsFeed ? 'text-green-600' : 'text-gray-400'}`}>
